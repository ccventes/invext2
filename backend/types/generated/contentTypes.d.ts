...
export interface ApiBannerMainBannerMain extends Schema.SingleType {
  ...
  attributes: {
    ImageRoute: Attribute.Media & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMenunavMenunav extends Schema.SingleType {
  ...
  attributes: {
    nav: Attribute.DynamicZone<['menu.dropdown', 'menu.single']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMenuppalMenuppal extends Schema.CollectionType {
  collectionName: 'menuppals';
  info: {
    singularName: 'menuppal';
    pluralName: 'menuppals';
    displayName: 'menuppal';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    boton: Attribute.Component<'menu.link', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::menuppal.menuppal',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
